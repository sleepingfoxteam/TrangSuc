...
namespace TrangSucSolution.Controllers
{
    public class PhieuXuatHangsController : Controller
    {
        ...
        {
            var phieuXuatHangs = db.PhieuXuatHangs.Include(p => p.NhanVien).Include(p => p.TrangSuc);
        ...
        public ActionResult Create([Bind(Include = "SoPhieu,MaMatHang,TenMatHang,SoLuong,DonGia,TongGiaTri,NgayXuat,NguoiXuat")] PhieuXuatHang phieuXuatHang)
        {
            ...
            ViewBag.MaMatHang = new SelectList(db.TrangSucs, "ID", "ID", phieuXuatHang.MaMatHang);
            return View(phieuXuatHang);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SoPhieu,MaMatHang,TenMatHang,SoLuong,DonGia,TongGiaTri,NgayXuat,NguoiXuat")] PhieuXuatHang phieuXuatHang)
        {
            if (ModelState.IsValid)
            {
